...
class HideOnline:
	...
	def register(
		...
		return self._post(f"/LoginWithAndroidDeviceID?sdk={self.sdk}", data)
	...
	def get_photon_token(self) -> dict:
		...
		return self._post(f"/GetPhotonAuthenticationToken?sdk={self.sdk}", data)
	...
	def get_title_data(
		...
		return self._post(f"/GetTitleData?sdk={self.sdk}", data)

	def get_server_time(self) -> dict:
		return self._post(f"/GetTime?sdk={self.sdk}")
